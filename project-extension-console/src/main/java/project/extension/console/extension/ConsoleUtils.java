...
public class ConsoleUtils {
    ...
    /// <returns></returns>
    public static  void ConsoleWriteAsync(this object data, int delay = -1, ConsoleColor color = ConsoleColor.White, string tag = null, bool line = true, int blankline = 0)
    {
